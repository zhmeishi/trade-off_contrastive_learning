...
def resnet34(pretrained=False, progress=True, device='cpu', num_classes=10, **kwargs):
...
def resnet50(pretrained=False, progress=True, device='cpu', num_classes=10, **kwargs):
...
def resnet101(pretrained=False, progress=True, device='cpu', num_classes=10, **kwargs):
...
def resnet152(pretrained=False, progress=True, device='cpu', num_classes=10, **kwargs):
...
def resnext50_32x4d(pretrained=False, progress=True, device='cpu', num_classes=10, **kwargs):
    ...
    return _resnet('resnext50_32x4d', Bottleneck, [3, 4, 6, 3],
                   pretrained, progress, device, num_classes, **kwargs)


def resnext101_32x8d(pretrained=False, progress=True, device='cpu', num_classes=10, **kwargs):
